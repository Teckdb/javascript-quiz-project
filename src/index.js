document.addEventListener("DOMContentLoaded", () => {
  ...
  resetButton.addEventListener("click", restarButtonHandler);
  ...
  function showQuestion() {
    ...
    const updateGreenBar = ((quiz.currentQuestionIndex + 1) / quiz.questions.length) * 100
    progressBar.style.width = `${updateGreenBar}%`; // This value is hardcoded as a placeholder
